...
function reelConfig(){
  reels_load.forEach(( reel, r ) => {
    reel.forEach(( reel_obj, reel_pos ) =>{
      ...
      reel_obj.sprite.position.y = (GRID_Y + GRID_PADDING) + (reel_obj.sprite.height * 3) - (reel_obj.sprite.height * 20) + ( reel_obj.sprite.height * reel_pos );
...
function reinsertarReelObj( reel_obj ) {
  ...
  if (reel_obj.sprite.position.y >= ((GRID_Y + GRID_PADDING) + (reel_obj.sprite.height * 2) + 7 )){
    reel_obj.sprite.position.y = ((GRID_Y + GRID_PADDING) + (reel_obj.sprite.height * 2)) - ( reel_obj.sprite.height * 20 );
  }
}
